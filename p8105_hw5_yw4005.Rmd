...
```
Take out Tulsa, AL because there was no unsolved homicides. So the numerator of the ratio is 0.
...
```
As the true mu increases, rejection rate grows as well. In other words, power grows as effect size grows.
...
```
As the true mu increases, sample average mu hat increases as well. Average mu hat of samples that reject the null are very close the true mu when the true mu is 4, 5, 6. When the true mu is less than 4, mu hat of samples that reject the null are larger than the true mu.
