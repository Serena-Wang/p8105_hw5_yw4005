...
Average mu hat of samples that reject the null are very close to the
true mu when the true mu is 4, 5, 6. When the true mu is less than 4, mu
hat of samples that reject the null are larger than the true mu.
